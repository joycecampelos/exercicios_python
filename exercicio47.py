...
print(f'O cliente com o código {códigobaixo}, é o mais baixo com {maisbaixo}m de altura.')
...
print(f'A média de altura e peso dos cliente, respectivamente, é {mediaaltura:.1f}m e {mediapeso:.1f}Kg.')
